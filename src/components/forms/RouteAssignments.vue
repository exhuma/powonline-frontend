      ...
      <v-flex xs6>
        <v-card class="mx-3">
          ...
          <div v-for="team in assignedTeams" :key="team.name">
            ...
            <v-flex xs6>
              <v-btn @click="unassignTeam(team)" text><v-icon>mdi-arrow-down</v-icon></v-btn>
            </v-flex>
          </div>
        </v-card>
      </v-flex>
      <v-flex xs6>
        <v-card class="mx-3">
          ...
          <div v-for="station in assignedStations" :key="station.name">
            ...
            <v-flex xs6>
              <v-btn @click="unassignStation(station)" text><v-icon>mdi-arrow-down</v-icon></v-btn>
            </v-flex>
          </div>
        </v-card>
      </v-flex>
      ...
      <v-flex xs6 class="mt-4">
        <v-card class="mx-3">
          ...
          <div v-for="team in unassignedTeams" :key="team.name">
            <v-flex xs6>{{ team }}</v-flex>
            <v-flex xs6>
              <v-btn @click="assignTeam(team)" text><v-icon>mdi-arrow-up</v-icon></v-btn>
            </v-flex>
          </div>
        </v-card>
      </v-flex>
      <v-flex xs6 class="mt-4">
        <v-card class="mx-3">
          ...
          <div v-for="station in unassignedStations" :key="station.name">
            <v-flex xs6>{{ station }}</v-flex>
            <v-flex xs6>
              <v-btn @click="assignStation(station)" text><v-icon>mdi-arrow-up</v-icon></v-btn>
            </v-flex>
          </div>
        </v-card>
      </v-flex>
