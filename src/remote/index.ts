...
export interface Proxy {
  ...
  unassignQuestionnaireFromStation(
    questionnaireName: string,
    eventId?: number
  ): Promise<unknown>
}
...
class FakeProxy implements Proxy {
  ...
  async deleteFile(_uuid: string): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async addTeam(_team: Team): Promise<Team> {
    throw new Error('Method not implemented.')
  }
  async updateTeam(_teamName: string, _newData: Team): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async fetchRoutes(): Promise<Route[]> {
    throw new Error('Method not implemented.')
  }
  async fetchQuestionnaires(_eventId?: number): Promise<Questionnaire[]> {
    throw new Error('Method not implemented.')
  }
  ...
  async updateQuestionnaire(
    _oldName: string,
    _newData: Questionnaire
  ): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async deleteQuestionnaire(_questionnaireName: string): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  ...
  async fetchUserRoles(_userName: string): Promise<string[]> {
    throw new Error('Method not implemented.')
  }
  fetchUserStations(_userName: string): Promise<[string, boolean][]> {
    throw new Error('Method not implemented.')
  }
  ...
  async deleteTeam(_teamName: string): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async deleteUser(_userName: string): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async deleteStation(_stationName: string): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async deleteRoute(_routeName: string): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  async addTeamToRoute(_routeName: string, _team: Team): Promise<unknown> {
    throw new Error('Method not implemented.')
  }
  ...
  async addUser(_user: User): Promise<User> {
    throw new Error('Method not implemented.')
  }
  async addRoute(_route: Route): Promise<Route> {
    throw new Error('Method not implemented.')
  }
  async addStation(_station: Station): Promise<Station> {
    throw new Error('Method not implemented.')
  }
  ...
  async fetchEventMembers(_eventId: number): Promise<EventMember[]> {
    return []
  }
  ...
  async deleteEvent(_eventId: number): Promise<unknown> {
    return {}
  }
  async fetchTeamsForEvent(eventId: number): Promise<Team[]> {
    return this.fetchTeams(eventId)
  }
  async addTeamForEvent(_eventId: number, team: Team): Promise<Team> {
    return team
  }
...
class ConcreteProxy implements Proxy {
  ...
  async removeUserRole(userName: string, roleName: string): Promise<string> {
    return this._json(`${this.baseUrl}/user/${userName}/roles/${roleName}`, {
      method: 'DELETE'
    })
  }
  ...
  async addTeamToRoute(
    ...
    return this._json(
      `${this.baseUrl}/events/${eventId}/route/${route}/teams`,
      {
        method: 'POST',
        body: JSON.stringify(team)
      }
  ...
  async unassignTeamFromRoute(
    ...
    return this._json(
      `${this.baseUrl}/events/${eventId}/route/${route}/teams/${team}`,
      { method: 'DELETE' }
    )
  }
  ...
  async deleteRoute(routeName: string, eventId?: number): Promise<unknown> {
    ...
    return this._json(`${this.baseUrl}/events/${eventId}/route/${routeName}`, {
      method: 'DELETE'
    })
  }
  ...
  async deleteFile(uuid: string, eventId?: number): Promise<unknown> {
    ...
    return this._json(`${this.baseUrl}/events/${eventId}/upload/${uuid}`, {
      method: 'DELETE'
    })
  }
